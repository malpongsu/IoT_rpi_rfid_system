...
if (isset($_POST["submit"])) {
  ...
  $sql = "UPDATE `user_db` SET `name`='$name',`email`='$email',`password`='$password',`user_type`='$user_type' WHERE id = $id";
...
<div class="home-content">
  <div class="title">STUDENTS - EDIT</div>
  <div class="attendance box">
    <form method="post">
      ...
      <button type="submit" name="submit" class="btn btn-primary" onclick="window.location.href='../admin_page/admin_account.php';">Update</button>
    </form>
  </div>
</div>
</body>
